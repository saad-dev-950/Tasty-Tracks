...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Assuming login returns the user object on success
      ...
      <div className="container" style={{ maxWidth: '500px' }}>
        <div className="feature-card text-start p-5">
          <div className="text-center mb-4">
            ...
            <p className="text-light opacity-75">Login to access your orders and favorites.</p>
          </div>
          ...
          <div className="text-center mt-4">
            <p className="text-light opacity-75 mb-0">
              Don't have an account? <Link to="/signup" className="text-warning text-decoration-none fw-bold">Sign up here</Link>
            </p>
          </div>
        </div>
      </div>
